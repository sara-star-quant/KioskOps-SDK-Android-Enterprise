...
sealed class TransportResult<out T> {
  ...
  data class TransientFailure(val message: String, val httpCode: Int? = null) : TransportResult<Nothing>()
  data class PermanentFailure(val message: String, val httpCode: Int? = null) : TransportResult<Nothing>()
}
