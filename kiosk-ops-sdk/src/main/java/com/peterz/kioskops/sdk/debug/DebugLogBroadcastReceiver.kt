 ...
 * ```
 * adb shell am broadcast -a com.peterz.kioskops.sdk.SET_LOG_LEVEL --es level VERBOSE
 * adb shell am broadcast -a com.peterz.kioskops.sdk.SET_LOG_LEVEL --es level OFF
 * ```
 *
...
class DebugLogBroadcastReceiver : BroadcastReceiver() {
  ...
  companion object {
    const val ACTION = "com.peterz.kioskops.sdk.SET_LOG_LEVEL"
