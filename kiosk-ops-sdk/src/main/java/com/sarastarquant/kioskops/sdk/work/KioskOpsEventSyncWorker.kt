...
class KioskOpsEventSyncWorker(
  ...
  override suspend fun doWork(): Result {
    ...
    return when (r) {
      is com.sarastarquant.kioskops.sdk.transport.TransportResult.Success -> Result.success()
      is com.sarastarquant.kioskops.sdk.transport.TransportResult.TransientFailure -> {
        android.util.Log.w(TAG, "Sync transient failure: ${r.message}; will retry")
        Result.retry()
      }
      is com.sarastarquant.kioskops.sdk.transport.TransportResult.PermanentFailure -> {
