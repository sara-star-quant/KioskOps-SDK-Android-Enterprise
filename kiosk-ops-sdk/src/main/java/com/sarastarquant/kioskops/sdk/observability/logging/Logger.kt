...
interface Logger {
   ...
   */
  fun isEnabled(level: com.sarastarquant.kioskops.sdk.observability.LogLevel): Boolean
}
...
object NoOpLogger : Logger {
  ...
  override fun isEnabled(level: com.sarastarquant.kioskops.sdk.observability.LogLevel): Boolean = false
}
